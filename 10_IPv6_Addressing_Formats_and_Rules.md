...
The physcial network topology shows on IPv6-only network on the left communication with an IPv4-only network on the right through a NAT64 router.
...
0.3.1 What Did I Learn in this Module?
